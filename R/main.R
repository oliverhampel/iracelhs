...
init                       s    ""     "--init"                        "uniform"          "Initialization mode: uniform, lhs-both, lhs-wsum, lhs-corr, lhs-energy, energy_euclidean_overlap"
...
irace.cmdline <- function(args = commandArgs (trailingOnly = TRUE), auxiliaryScenario = list())
{
  ...
  scenario <- readScenario(scenarioFile, auxiliaryScenario)
