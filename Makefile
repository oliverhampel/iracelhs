...
help:
	@echo "quick-install  install the package with minimum dependencies and no vignettes"
...
vignettes: version vignettes/$(PACKAGE)-package.Rnw vignettes/$(PACKAGE)-package.bib
# FIXME: How to do all this on a temporary directory to avoid people editing the .tex file directly?
# R CMD Sweave --pdf --clean --verbose $(PACKAGE)-package.Rnw
